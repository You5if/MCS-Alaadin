...
import { SysWarehouseEntryService } from './syswarehouse-entry.service';
import { Direction } from '@angular/cdk/bidi';
import { MatDialogRef, MAT_DIALOG_DATA } from '@angular/material/dialog';

@Component({
  selector: 'app-syswarehouse-entry',
  templateUrl: './syswarehouse-entry.component.html',
  styleUrls: ['./syswarehouse-entry.component.scss']
})

export class SysWarehouseEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SysWarehouseEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SysWarehouseEntryComponent>,
