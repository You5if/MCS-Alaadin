...
import { SysCompUser2EntryComponent } from './syscompuser-entry/syscompuser-entry.component';
...
export class SysCompUser2Component implements OnInit {
...
phone!: string;
  ...
  onAdd  () {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "Add employee");
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "اضافة موظف");
    }
  ...
  onEdit = (id: number) => {
    ...
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "Edit employee");
    }else if(localStorage.getItem(this._globals.baseAppName + '_language') == "16002") {
      localStorage.setItem(this._globals.baseAppName + '_Add&Edit', "تعديل موظف");
    }
  ...
  openEntry  (result: SysCompUserModel) {
    if (result === undefined) {
      const dialogRef = this.dialog.open(SysCompUser2EntryComponent, {
        disableClose: true,
        data: {}
      });
      dialogRef.afterClosed().subscribe(() => {
