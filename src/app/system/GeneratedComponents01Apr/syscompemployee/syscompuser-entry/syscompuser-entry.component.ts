...
import { SysCompUserEntryService } from './syscompuser-entry.service';
import { Direction } from '@angular/cdk/bidi';
import { MatDialogRef, MAT_DIALOG_DATA } from '@angular/material/dialog';

@Component({
  selector: 'app-syscompuser-entry',
  templateUrl: './syscompuser-entry.component.html',
  styleUrls: ['./syscompuser-entry.component.scss']
})

export class SysCompUser2EntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SysCompUserEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SysCompUser2EntryComponent>,
