...
import { LoadPlanEntryService } from './loadplan-entry.service';
import { Direction } from '@angular/cdk/bidi';
import { MatDialogRef, MAT_DIALOG_DATA } from '@angular/material/dialog';

@Component({
  selector: 'app-loadplan-entry',
  templateUrl: './loadplan-entry.component.html',
  styleUrls: ['./loadplan-entry.component.scss']
})

export class LoadPlanEntryComponent implements OnInit {
  ...
  constructor(
      ...
      private dialogRef: MatDialogRef<LoadPlanEntryComponent>,
